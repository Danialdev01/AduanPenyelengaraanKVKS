<?php $title = "Kemaskini Aset KVKS"; $location_index = "../.."; include('../../components/head.php')?>
<body>
    ...
    <div class="main-container p-2">
        <br><br>
        <center>
            <h1 class="text-lg"><b>Kemaskini Aset</b></h1>
            <br>
            <div
                ...
                <form action="./system/kemaskini-aset.php" method="post">
                    ...
                    <div class="relative mb-6">
                        <select name="jenis_aset" data-te-select-init data-te-select-filter="true" required>
                            ...
                            <option <?php echo $aset['jenis_aset'] == 'ELEKTRONIK' ? 'selected' : 'ELEKTRONIK'; ?> value="ELEKTRONIK">ELEKTRONIK</option>
                            <option <?php echo $aset['jenis_aset'] == 'ASET ALIH' ? 'selected' : 'ASET ALIH'; ?> value="ASET ALIH">ASET ALIH</option>
                            <option <?php echo $aset['jenis_aset'] == 'KOMPUTER' ? 'selected' : 'KOMPUTER'; ?> value="KOMPUTER">KOMPUTER</option>
                        </select>
                    </div>
