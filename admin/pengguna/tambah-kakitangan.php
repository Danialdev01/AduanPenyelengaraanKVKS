<?php $title = "Tambah Pengguna"; $location_index = "../.."; include('../../components/head.php')?>
<body>
    ...
    <div class="main-container p-2">
        <br><br>
        <center>
            <h1 class="text-lg"><b>Tambah Staf / Pensyarah</b></h1>
            <br>
            <div
                ...
                <form action="./system/tambah-kakitangan.php" method="post">
