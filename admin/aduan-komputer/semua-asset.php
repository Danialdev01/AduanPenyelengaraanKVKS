<?php $title = "Semua Asset"; $location_index = "../.."; include('../../components/head.php')?>
<body>
    ...
    <div class="main-container p-2">
                                    ...
                                    <?php
                                        ...
                                        while($asset = mysqli_fetch_array($asset_sql)){
                                            ...
                                            <tr
                                                ...
                                                <td class="whitespace-nowrap px-6 py-4"><?php echo $asset['nama_asset']?></td>
                                                <td class="whitespace-nowrap px-6 py-4"><?php echo $asset['jenis_asset']?></td>
        ...
        <div class="button-add-asset">
            <a href="./tambah-asset.php">
