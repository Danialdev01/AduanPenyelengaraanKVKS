<?php $title = "Tambah Asset"; $location_index = "../.."; include('../../components/head.php')?>
<body>
    ...
    <div class="main-container p-2">
        <br><br>
        <center>
            <h1 class="text-lg"><b>Tambah Asset</b></h1>
            <br>
            <div
                ...
                <form action="./system/tambah-asset.php" method="post">
                    ...
                    <input type="hidden" name="jenis_asset" value="ELEKTRONIK">
